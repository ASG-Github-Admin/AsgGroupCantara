function Suspend-CantaraScheduler {
    ...
    process {
        ...
        try {
            ...
            $Params = @{
                ...
                Method      = "Post"
                Uri         = "$URI/service/scheduler/suspend"
            ...
            if ($Req.Message.'#text' -eq "Transaction Successful") {
                ...
                "The Cantara scheduler accepted the suspend request - $($Req.Message.'#text')" | Write-Debug
                Write-Verbose -Message "The Cantara scheduler accepted the suspend request"
            }
            else {

                "The Cantara scheduler did not accept the suspend request - $($Req.Message.'#text')" |
                    Write-Warning
            }
        }
